package org.cucumberpeople.eclipse.plugin.common.report;
...
import org.cucumberpeople.eclipse.plugin.common.report.charts.FlashChartBuilder;
import org.cucumberpeople.eclipse.plugin.common.report.charts.JsChartUtil;
import org.cucumberpeople.eclipse.plugin.common.report.json.Feature;
import org.cucumberpeople.eclipse.plugin.common.report.util.UnzipUtils;
import org.cucumberpeople.eclipse.plugin.common.report.util.Util;
...
public class ReportBuilder {
    ...
    private final String VERSION = "cucumber-builder-1.0.1";

    @SuppressWarnings("static-access")
	public ReportBuilder(List<String> jsonReports, String copyrightName,File reportDirectory, String pluginUrlPath, String buildProject,String buildNumber, boolean skippedFails, boolean undefinedFails, boolean flashCharts, boolean runWithJenkins, boolean artifactsEnabled, String artifactConfig, boolean highCharts) throws Exception {
    ...
    public void generateReports(String videofile) throws Exception {
        try {
    ...
    public void generateTagReports() throws Exception {
        for (TagObject tagObject : ri.getTags()) {
            ...
            String tagfilename="";
            if(tagName.contains("http://")||tagName.contains("https://")){
            	String[] temptagfilename=tagName.split("/");
            	tagfilename=temptagfilename[temptagfilename.length-1]+".html";
            }else{
            	tagfilename=tagName.replace("@", "").trim() + ".html";
            }
            generateReport(tagfilename, featureResult, contextMap.getVelocityContext());
    ...
    public void generateReplayPage(String videofile) throws Exception{
    	 VelocityEngine ve = new VelocityEngine();
         ve.init(getProperties());
         Template videoresult = ve.getTemplate("templates/replayOverview.vm");
         VelocityContextMap contextMap = VelocityContextMap.of(new VelocityContext());
         contextMap.putAll(getGeneralParameters());
         //contextMap.put("tag", tagObject);
         ...
         contextMap.put("video_file", videofile);
        // contextMap.put("screenshot_file", screenshotfile);
         
         generateReport("replay-overview.html", videoresult, contextMap.getVelocityContext());
    ...
    private HashMap<String, Object> getGeneralParameters() {
        ...
        result.put("copyright_name", copyrightName);
