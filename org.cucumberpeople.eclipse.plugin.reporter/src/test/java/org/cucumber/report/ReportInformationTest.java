...
import org.cucumberpeople.eclipse.plugin.common.report.ConfigurationOptions;
...
import org.cucumberpeople.eclipse.plugin.common.report.TagObject;
...
public class ReportInformationTest {
    ...
    public void setUpReportInformation() throws IOException, URISyntaxException {
        ...
        jsonReports.add(new File(ReportInformationTest.class.getClassLoader().getResource("org/cucumber/report/project1.json").toURI()).getAbsolutePath());
        jsonReports.add(new File(ReportInformationTest.class.getClassLoader().getResource("org/cucumber/report/project2.json").toURI()).getAbsolutePath());
